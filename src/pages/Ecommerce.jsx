...
import { PieChart, Button, LineChart, BarChart } from '../components';
        ...
        <div className='bg-white dark:text-gray-200 dark:bg-secondary-dark-bg m-3 rounded-2xl md:w-780'>
            ...
            <div className='mt-10 flex gap-10 flex-wrap justify-center'>
              <div className='border-r-1 border-color m4 pr-10'>
                <div>
                  <p>
                    <span className='text-3xl font-semibold'>$94,860</span>
                ...
                <div className='mt-8'>
                  <p>
                    <span className='text-3xl font-semibold'>$34,860</span>
                  </p>
