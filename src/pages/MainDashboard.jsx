  ...
  return (
    <div className="mt-12">
      <div className="flex  flex-wrap lg:flex-nowrap justify-center ">
        <div className="bg-white dark:text-gray-200 dark:bg-secondary-dark-bg h-44 rounded-xl w-full lg:w-80 p-8 pt-9 m-3 bg-hero-pattern bg-opacity-50 md:bg-opacity-50 bg-no-repeat bg-cover bg-center">
          <div className="flex justify-between items-center">
            <div>
              <p className="font-bold text-gray-400 bg-white rounded-tl-lg rounded-tr-lg">Profit</p>
              <p className="text-2xl font-bold text-dark-400 bg-white rounded-bl-lg rounded-br-lg">$63,448.78</p>
            </div>
            {/* <button
              type="button"
